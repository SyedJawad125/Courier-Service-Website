"""
Django settings for courier_site project.
...
SECRET_KEY = 'django-insecure-71j1&5)%@^ff1k9nkrvbm&vjtl488floc%ei4gsb8+h&(4dj&n'
...
ROOT_URLCONF = 'courier_site.urls'
...
WSGI_APPLICATION = 'courier_site.wsgi.application'
